            ...
            if ($cantidad > 0) {
                ...
                for ($i = 1; $i <= $cantidad; $i++) {
                    ...
                    if ($prod != 0) {
                        ...
                        $sql = "SELECT * FROM detalle_pedido WHERE created_on BETWEEN DATE_SUB('".$fecha_hora."', INTERVAL 182 DAY) AND '".$fecha_hora."' AND detalle_maestra_id=".$prod." AND cantidad=".$cantidad_prod.' ORDER BY created_on';
            ...
            if ($cantidad > 0) {
                ...
                for ($i = 1; $i <= $cantidad; $i++) {
                    ...
                    if ($prod != 0) {
                        ...
                        $sql = "SELECT * FROM detalle_pedido_especial WHERE created_on BETWEEN DATE_SUB('".$fecha_hora."', INTERVAL 182 DAY) AND '".$fecha_hora."' AND maestra_especial_id=".$prod." AND cantidad=".$cantidad_prod.$stringPrecio.' ORDER BY created_on';
