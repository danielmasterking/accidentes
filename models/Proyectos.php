...
class Proyectos extends \yii\db\ActiveRecord
{
   ...
   public $image2;//imagen que acompaña el detalle.
    ...
    {
        return [
            [['ceco', 'solicitante', 'presupuesto_total', /*'presupuesto_seguridad', 'presupuesto_riesgo',*/ 'presupuesto_activo', 'presupuesto_gasto', 'fecha_finalizacion', 'created_on'], 'required'],
