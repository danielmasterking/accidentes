...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="#" class="logo">
      <!-- mini logo for sidebar mini 50Ix50 pixels -->
      <span class="logo-mini"><b>S</b>ST</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>S</b>ST</span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="https://st4.depositphotos.com/18664664/21428/v/1600/depositphotos_214280710-stock-illustration-management-vector-icon-isolated-on.jpg" class="user-image" alt="User Image">
              <span class="hidden-xs"><?= Yii::$app->session['usuario-exito']?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a data-confirm='Seguro deseas salir?' href="<?= Yii::$app->request->baseUrl.'/site/logout'?>" class="btn btn-default btn-flat">Salir</a>
                </div>
              </li>
            </ul>
          </li>
