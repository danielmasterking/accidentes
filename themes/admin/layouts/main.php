...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=0">
     <?= Html::csrfMetaTags() ?>
    <link rel="shortcut icon" type="image/x-icon" href="<?php echo $this->theme->baseUrl; ?>/assets/img/favicon.ico">
    <title><?= Html::encode($this->title) ?></title>
    <?php $this->head() ?>
    <link rel="stylesheet" type="text/css" href="<?php echo $this->theme->baseUrl; ?>/assets/css/bootstrap.min.css">
    <link rel="stylesheet" type="text/css" href="<?php echo $this->theme->baseUrl; ?>/assets/css/font-awesome.min.css">
...
<body>
        ...
        <div class="header">
			<div class="header-left">
				<a href="index-2.html" class="logo">
					<img src="<?php echo $this->theme->baseUrl; ?>/assets/img/logo.png" width="35" height="35" alt=""> <span>Preclinic</span>
				</a>
			</div>
    ...
    <script src="<?php echo $this->theme->baseUrl; ?>/assets/js/jquery-3.2.1.min.js"></script>
