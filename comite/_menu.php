...
<div class="col-md-2">
   ...
   <li ><?php echo Html::a('<i class="fa fa-home fa-fw"></i>Dependencias',Yii::$app->request->baseUrl.'/centro-costo/index');?></li>
	<?php if(in_array("capacitacion", $permisos)):?>
	  
	  <li ><?php echo Html::a('<i class="fa fa-dot-circle-o fa-fw"></i>Capacitación',Yii::$app->request->baseUrl.'/capacitacion/create');?></li>
	  
	<?php endif;?>
	
	<?php if(in_array("comite", $permisos)):?>
	  
	  <li class="active"><?php echo Html::a('<i class="fa fa-dot-circle-o fa-fw"></i>Comite',Yii::$app->request->baseUrl.'/comite/create');?></li>
	  
	<?php endif;?>
	
	<?php if(in_array("siniestro", $permisos)):?>
	  
	  <li ><?php echo Html::a('<i class="fa fa-dot-circle-o fa-fw"></i>Siniestro',Yii::$app->request->baseUrl.'/siniestro/create');?></li>
	  
	<?php endif;?>
	
	<?php if(in_array("visita", $permisos)):?>
	  
	  <li ><?php echo Html::a('<i class="fa fa-dot-circle-o fa-fw"></i>Visita Diaria',Yii::$app->request->baseUrl.'/visita-dia/create');?></li>
	...
	<?php if(in_array("administrador", $permisos)):?>
	   ...
	   <li ><?php echo Html::a('<i class="fa fa-dot-circle-o fa-fw"></i>Zonas',Yii::$app->request->baseUrl.'/zona/index');?></li>
	   ...
	   <li ><?php echo Html::a('<i class="fa fa-dot-circle-o fa-fw"></i>Mensaje Novedades',Yii::$app->request->baseUrl.'/mensaje-novedad/index');?></li>
    ...
    <?php endif;?>
	 <li ><?php echo Html::a('<i class="fa fa-home fa-fw"></i>Salir',Yii::$app->request->baseUrl.'/site/logout');?></li>
   </ul>
</div>  