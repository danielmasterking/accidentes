 ...
 <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
   ...
   <li ><?php echo Html::a('<i class="fa fa-building-o fa-fw"></i>Dependencias',Yii::$app->request->baseUrl.'/centro-costo/index');?></li>
	...
	<?php if(in_array("orden-compra", $permisos)):?>
	  ...
	  <li ><?php echo Html::a('<i class="fa fa-file fa-fw"></i>Creación OC/Solicitud',Yii::$app->request->baseUrl.'/pedido/orden-compra');?></li>
	  
	<?php endif;?>	
	
	<?php if(in_array("consolidado", $permisos)):?>
	  
	  <li ><?php echo Html::a('<i class="fa fa-handshake-o fa-fw"></i>Consolidados',Yii::$app->request->baseUrl.'/pedido/consolidar');?></li>  
	  
	<?php endif;?>	

	<?php if(in_array("prefactura", $permisos)):?>
	  
	  <li ><?php echo Html::a('<i class="fa fa-file-excel-o fa-fw"></i>Prefactura',Yii::$app->request->baseUrl.'/prefactura-fija/create');?></li>  
	...
	<?php if(in_array("administrador", $permisos)):?>
	   ...
	   <li  class="active"><?php echo Html::a('<i class="fa fa-dot-circle-o fa-fw"></i>Area Dependencia',Yii::$app->request->baseUrl.'/area-dependencia/index');?></li>
	   ...
	   <li ><?php echo Html::a('<i class="fa fa-wrench fa-fw"></i>Maestras',Yii::$app->request->baseUrl.'/proveedor/index');?></li>  
       <li ><?php echo Html::a('<i class="fa fa-balance-scale fa-fw"></i>Equivalencia',Yii::$app->request->baseUrl.'/equivalencia/create');?></li>  
	   <li ><?php echo Html::a('<i class="fa fa-cogs fa-fw"></i>Conf-Prefactura',Yii::$app->request->baseUrl.'/empresa/create');?></li>
