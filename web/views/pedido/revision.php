...
<?php $form2 = ActiveForm::begin(); ?>	    
	 <table  class="display my-data" data-page-length='20' cellspacing="0" width="100%">
       ...
       <tr>
		   ...
		   <th>Ordinario</th>
		   <th>Solicitante</th>
		   <th><?= Html::a('Seleccionados', ['pedido/aprobar-producto-coordinador-todos'], ['data-method'=>'post','class' => 'btn btn-primary']);?></th>
		   <th>
             ...
             <?php foreach($pendientes as $pendiente):?>	
              ...
              if($flag):?>
				  ...
				  <tr>			   
					...
					<?php Pjax::begin(); ?>
					  <?= Html::a('<i class="fa fa-check" aria-hidden="true"></i>', ['pedido/aprobar-producto?id_detalle_producto='.$pendiente->id], ['class' => 'btn btn-primary']);?>
					<?php Pjax::end(); ?>
