...
$this->title = 'Historico de pedidos';
...
?>
	...
	<div class="col-md-12">
	   <?= Html::a('Especiales',Yii::$app->request->baseUrl.'/pedido/historico-especial',['class'=>'btn btn-primary']) ?>
   </div>
   <form id="form_excel" method="post" action="<?php echo Url::toRoute('pedido/historico')?>">
	   <div class="row">
 ...
 <script>
 	function eliminarPedido(id){
 		var url="<?php echo Url::toRoute('pedido/eliminar-pedido')?>";
	...
	function consultar(page){
		...
		$.ajax({
            url:"<?php echo Url::toRoute('pedido/historico')?>",
            type:'POST',
            dataType:"json",
            cache:false,
            data: {
