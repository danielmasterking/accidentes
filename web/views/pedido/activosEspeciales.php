...
$this->title = 'Agregar código de activo pedido especial';
...
<?= $this->render('_tabsFinanciera',['activos' => $activos]) ?>
   ...
   <?= Html::a('Normales',Yii::$app->request->baseUrl.'/pedido/codigo-activos',['class'=>'btn btn-primary']) ?>			
  ...
  <?php $form2 = ActiveForm::begin(); ?>	      
	 <table  class="display my-data" data-page-length='20' cellspacing="0" width="100%">
       ...
       <tr>
		   ...
		   <th>Dependencia</th>
		   <th>Producto Maestra</th>
		   <th>Producto Sugerido</th>
		   <th>Cantidad</th>
           <th>Ceco</th>
		   <th>Precio sugerido </th>
		   <th>Precio Maestra (UN)</th>
	   ...
	   <tbody>
             ...
             <?php foreach($pendientes as $pendiente):?>	  
              ...
              <tr>			   
				...
				<td><?= $pendiente->precio_sugerido?></td>
				...
				<?php Pjax::begin(); ?>
				  <?= Html::a('<i class="fa fa-check" aria-hidden="true"></i>', ['pedido/activo-asignado-especial?id_detalle_producto='.$pendiente->id], ['class' => 'btn btn-primary']);?>
				<?php Pjax::end(); ?>
				...
				<?php Pjax::begin(); ?>
				  <?= Html::a('<i class="fa fa-arrow-left" aria-hidden="true"></i>', ['pedido/regresar-financiera-especial-from-activo?id_detalle_producto='.$pendiente->id], ['class' => 'btn btn-primary']);?>
				<?php Pjax::end(); ?>
