...
<nav class="navbar navbar-default" role="navigation">
 ...
 <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
   ...
   <li ><?php echo Html::a('<i class="fa fa-home fa-fw"></i>Dependencias',Yii::$app->request->baseUrl.'/centro-costo/index');?></li>
	<?php if(in_array("administrador", $permisos) || in_array("cordinador", $permisos)):?>
	
	  <li class="active"><?php echo Html::a('<i class="fa fa-user fa-fw"></i>Coordinadores',Yii::$app->request->baseUrl.'/usuario/cordinadores');?></li>
	...
	<?php if(in_array("visita", $permisos)):?>
	  ...
	  <li ><?php echo Html::a('<i class="fa fa-dot-circle-o fa-fw"></i>Visitas',Yii::$app->request->baseUrl.'/visita-dia/create');?></li>
