...
<?= Html::a('<i class="fa fa-arrow-left"></i> Volver ',Yii::$app->request->baseUrl.'/gestionriesgo/index',['class'=>'btn btn-primary']) ?>

<a href="<?php echo Url::toRoute('gestionriesgo/imprimir?id='.$model->id)?>" class="btn btn-danger " >
