...
<script>
	...
	$("#modeloprefactura-horas").on('change',function(){
   	...
   	function calcularHoraFin(){
   		var hora_sumar = moment.utc($("#modeloprefactura-horas").val(), "hh-mm").hour();
   		var minuto_sumar = moment.utc($("#modeloprefactura-horas").val(), "hh-mm").minute();
   		var hora_final = moment.utc($("#modeloprefactura-hora_inicio").val(), "hh-mm");
   	...
   	function calcularHorasDiurnasNocturnas(){
   		var jornada=moment.utc($("#modeloprefactura-hora_inicio").val(), "hh:mm");
   		hora_inicio=moment.utc($("#modeloprefactura-hora_inicio").val(), "hh:mm");
