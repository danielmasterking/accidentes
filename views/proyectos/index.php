...
$this->title = 'Presupuestos Proyectos';
?>
<ol class="breadcrumb">
  <li><a href="#">Inicio</a></li>
  <li>Presupuestos Proyectos</li>
</ol>
...
<?php 
	...
	//if(in_array("Analista Financiero", $permisos) || in_array("administrador", $permisos)){
	 	echo Html::a('Crear Proyecto', ['create'], ['class' => 'btn btn-primary']);
	//}
?>
</p>
...
<script>
	...
	function eliminar(id){
		var r = confirm("¿Seguro desea Eliminar este Presupuesto?");
		if (r == true) {
		    location.href="<?php echo Url::toRoute('proyectos/delete?id=');?>"+id;
		}
	}
 </script>